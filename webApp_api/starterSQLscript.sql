    ...
    INSERT INTO match (user_id, weapon_id, arena_id, enemies_spotted, kills, deaths, score, status) VALUES
        (1, 1, 1, 10, 5, 2, 30, 'finished'),
        (2, 2, 1, 8, 3, 1, 25, 'finished'),
        (3, 3, 2, 12, 7, 4, 40, 'finished');
